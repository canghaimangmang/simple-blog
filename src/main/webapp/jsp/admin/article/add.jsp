            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="summary" class="form-control" id="summary" placeholder="请输入摘要"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="createdDate" id="indate" type="text" placeholder="请选择"  readonly>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $("#articleForm").submit(function () {
        $.post("${ctx}/admin/article/add",$(this).serialize(),function (data) {
            if(data.status!= null && data.status != 100){
                alert(data.message);
            }else{
                alert("提交成功");
                __goto("${ctx}/admin/article/add")
            }
